...
const styles = {
  container: { maxWidth: '1200px', margin: '0 auto', padding: '36px 24px 64px', background: '#f0f2f5', minHeight: 'calc(100vh - 64px)' },
  heading: { fontSize: '1.3rem', marginBottom: '24px', color: '#1a1a2e', fontWeight: '700' },
  empty: { textAlign: 'center', padding: '60px', fontSize: '1rem', color: '#6b7280' },
  link: { color: '#3a86ff', fontWeight: '500' },
  ...
  image: { width: '80px', height: '80px', objectFit: 'cover', borderRadius: '8px', background: '#f5f7fa' },
  itemInfo: { flex: 1 },
  itemName: { color: '#1a1a2e', textDecoration: 'none', fontWeight: '500', fontSize: '0.92rem' },
  itemPrice: { color: '#9ca3af', marginTop: '4px', fontSize: '0.82rem' },
  itemQty: { color: '#6b7280', fontSize: '0.88rem', minWidth: '60px' },
  itemTotal: { fontWeight: '700', minWidth: '70px', textAlign: 'right', color: '#1c3557' },
  removeBtn: {
  ...
  summaryTitle: { fontSize: '0.88rem', marginBottom: '16px', color: '#9ca3af', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '1px' },
  summaryTotal: { fontSize: '1.6rem', fontWeight: '700', marginBottom: '20px', color: '#1c3557' },
  checkoutBtn: {
    width: '100%', padding: '13px', backgroundColor: '#1c3557',
